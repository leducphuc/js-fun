...
function () {
  ...
  _createClass(_Promise, [{
    ...
    value: function resolve(params) {
      ...
      if (this.handlers.length) {
        ...
        if (params instanceof _Promise) {
          ...
          setTimeout(function () {
            var nextChain = new _Promise(function (resolve) {
    ...
    value: function _catch(callback) {
      ...
      if (this.status === 0) {
        ...
        return new _Promise(function (_, reject) {
          return reject(callback(_this4.value));
        });
      }
    }
  }, {
    ...
    key: "handleReject",
    value: function handleReject(error) {
      if (this.catcher) {} else {// throw error
      }
    }
  }]);
...
},{"rxjs":"node_modules/rxjs/_esm5/index.js"}],"ex1.js":[function(require,module,exports) {
"use strict";
